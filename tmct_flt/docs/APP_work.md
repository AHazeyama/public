...
　この章のコマンドは全て<img src="./assets/env/M_SHELL_PoewrShell.png" height="12"> にて実行  
> [!TIP] PowerShell Syntax  
> |　　: 次のコマンドへ処理結果を渡す  
> `　　: 1つのコマンドを次の行へ継続  
> { }　: スクリプトブロック。} まで複数行で記述可能  
> ␣　 : 行頭では主にインデント（可読性向上）  
...
### 　Android 環境  
#### 　既存環境確認  
　<img src="./assets/env/M_get-childitem.png">  
  
　<img src="./assets/prtsc/APP-01-03_get-childitem.png">  
  
#### 　Path確認  
　<img src="./assets/env/M_env-Path.png">  
...
　<img src="./assets/env/M_dartpaths.png">  
...
　<img src="./assets/env/M_remove-item-local.png">  
...
　<img src="./assets/env/M_remove-item-appdata.png"> [<img src="./assets/env/M_copy.png" height="14">](aaaahhh)  
　# 正常に削除できればメッセージ無し  
...
<img src="./assets/env/M_get-childitem-local.png" alt="PowerShell command example">  
